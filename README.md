...
1. Xem [Bản đồ Hệ thống Tài liệu](DOCUMENTATION_MAP.md) để hiểu rõ cấu trúc thư mục, mối quan hệ giữa các playbooks, checklists và templates.
2. Xem [Bản đồ Quy trình trực quan](Agentic_SDLC_Master_Map.md) để có cái nhìn toàn cảnh bằng sơ đồ luồng.
3. Đọc [overview](docs/00-overview.md) để hiểu cấu trúc bộ tài liệu.
4. Chọn playbook theo vấn đề cần giải quyết:
...
5. Copy template phù hợp từ `templates/` vào repo sản phẩm thật.
6. Dùng checklist trong `checklists/` trước khi merge hoặc release.
7. Xem ví dụ hoàn chỉnh trong `examples/sample-enterprise-feature/`.

## Artifact chính

- [DOCUMENTATION_MAP.md](DOCUMENTATION_MAP.md): Bản đồ hệ thống tài liệu và cấu trúc dự án (danh mục chi tiết, sơ đồ quan hệ tài liệu và bảng ánh xạ theo 8 pha ADLC).
- [Agentic_SDLC_Master_Map.md](Agentic_SDLC_Master_Map.md): Bản đồ quy trình trực quan hóa bằng 8 sơ đồ Mermaid chi tiết.
